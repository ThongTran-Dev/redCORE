...
class RHelperDocument
{
	...
	public static function rmScript($script)
	{
		$document = RFactory::getDocument();
	...
	public static function rmStyle($style)
	{
		$document = RFactory::getDocument();

		echo '<pre>';
		echo print_r($document->_styleSheets);
		echo '</pre>';
		...
		echo '<pre>';
		echo var_dump(isset($document->_styleSheets[$style]));
		echo '</pre>';

		if (isset($document->_styleSheets[$style]))
		{
			unset($document->_styleSheets[$style]);
		}
	}
}
