...
echo RLayoutHelper::render('component.adminlte.assets');
...
<script type="text/javascript">
	jQuery(document).ready(function () {
		...
		jQuery('.message-sys').append(messageContainer);
...
<?php
	...
	<?php echo RLayoutHelper::render('component.adminlte.full', $displayData); ?>
</div>
<?php endif;
